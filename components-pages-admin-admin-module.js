...
/* harmony import */ var _form_product_form_product_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form-product/form-product.component */ "OqBg");
...
const routes = [
    {
        path: "formProduct", component: _form_product_form_product_component__WEBPACK_IMPORTED_MODULE_3__["FormProductComponent"]
    }
];
class AdminModule {
}
...
FormProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FormProductComponent, selectors: [["app-form-product"]], decls: 31, vars: 3, consts: [[1, "container"], [1, "row", "align-items-center"], [1, "col-12", "col-md-6"], ["src", "assets/ilustrations/save.svg", "alt", "", 1, "img-fluid"], [1, "card", "card-body"], [1, "fa-solid", "fa-box"], [3, "formGroup"], [1, "row"], [1, "col-12"], ["for", "image"], ["type", "file", "multiple", "", "id", "image", 1, "form-control"], ["for", "name"], ["type", "text", "formControlName", "name", "placeholder", "Nombre", "id", "name", 1, "form-control"], ["for", "description"], ["id", "description", "formControlName", "description", "cols", "5", "rows", "3", "placeholder", "Descripci\u00F3n", 1, "form-control"], ["for", "price"], ["type", "text", "id", "price", "formControlName", "price", "placeholder", "$", 1, "form-control"], ["type", "button", 1, "btn", "btn-outline-success", "mt-3", 3, "disabled"], [1, "fa-solid", "fa-floppy-disk"]], template: function FormProductComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "Seleccionar imagenes");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
